...
export class InitMigration1758049215156 implements MigrationInterface {
  name = 'InitMigration1758049215156';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firebaseUid" character varying NOT NULL, "email" citext, "phone" citext, "emailVerified" boolean NOT NULL DEFAULT true, "isActive" boolean NOT NULL DEFAULT true, "lastLoginAt" TIMESTAMP, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "profile_id" uuid, CONSTRAINT "UQ_e621f267079194e5428e19af2f3" UNIQUE ("firebaseUid"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_a000cca60bcf04454e727699490" UNIQUE ("phone"), CONSTRAINT "REL_23371445bd80cb3e413089551b" UNIQUE ("profile_id"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "ride_participants" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."ride_participants_status_enum" NOT NULL DEFAULT 'pending', "created_at" TIME WITH TIME ZONE NOT NULL DEFAULT now(), "ride_id" uuid, "user_id" uuid, "role_id" character varying, CONSTRAINT "PK_e83231dd0230d8b127ad96a8b2c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
